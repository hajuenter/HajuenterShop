    ...
    if (!isset($_POST['remember-me'])) {
        ...
        if ($row = mysqli_fetch_assoc($result)) {
            ...
            if (empty($txtpassword)) {
                echo "<script>alert('Harap masukkan password');</script>";
...
<div class="bg-white font-[sans-serif]">
      <div class="min-h-screen flex flex-col items-center justify-center py-0 px-4">
        <div class="max-w-md w-full">
          <img src="./img/logo14-removebg-preview.png" alt="logo" class="w-40 pb-0 mb-0 mx-auto block"/>  
          <div class="p-8 rounded-2xl bg-gradient-to-r from-slate-900 to-slate-700 border-3 border-indigo-300">
            ...
            <form method="post" class="mt-8 space-y-4">
              <div>
                ...
                <div class="relative flex items-center">
                  <input name="txtemail" type="email" required class="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md" placeholder="Enter email"/>
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  <input name="txtpassword" type="password" required class="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md" placeholder="Enter password" />
