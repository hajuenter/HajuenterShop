...
<body>
  <div class="font-[sans-serif] text-[#333] bg-slate-700 flex items-center md:h-screen p-4">
    <div class="w-full max-w-4xl mx-auto">
      <div class="bg-gradient-to-r from-slate-900 to-slate-700 grid md:grid-cols-2 lg:gap-24 gap-16 w-full sm:p-8 p-6 rounded overflow-hidden border-3 border-white">
          ...
          <div class="grayscale hover:grayscale-0 flex lg:items-center lg:justify-center">
            ...
            <div class="md:mb-16 mb-8">
              <h3 class="text-2xl font-extrabold text-indigo-500">Instant Access</h3>
            </div>
            <div class="space-y-6">
              <button type="button"
          ...
          <form method="post" class="w-full">
            ...
            <p class="text-sm mt-6 text-center text-neutral-400">Already have an account? <a href="javascript:void(0);" class="text-blue-600 font-semibold hover:underline ml-1">Login here</a></p>
          </form>
        </div>
      </div>
    </div>
