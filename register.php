    ...
    <div class="w-full max-w-4xl mx-auto">
      <div class="bg-gradient-to-r rounded-2xl from-slate-900 to-slate-700 grid md:grid-cols-2 lg:gap-24 gap-2 w-full sm:p-8 p-6 overflow-hidden border-3 border-white">
        <div class="max-md:order-1 space-y-6">
          ...
          <div class="md:mb-16 mb-2">
            <h3 class="text-2xl font-extrabold text-center text-indigo-500">Instant Access</h3>
          </div>
          <div class="space-y-3 md:space-y-6 lg:space-y-7">
            <button type="button" class="w-full px-2 py-3 flex items-center justify-center rounded text-white text-base tracking-wider font-semibold border-none outline-none bg-blue-600 hover:bg-blue-700">
            ...
            <button type="button" class="w-full px-2 py-3 flex items-center justify-center rounded text-[#333] text-base tracking-wider font-semibold border-none outline-none bg-gray-100 hover:bg-gray-200">
            ...
            <button type="button" class="w-full px-2 py-3 flex items-center justify-center rounded text-white text-base tracking-wider font-semibold border-none outline-none bg-black hover:bg-[#333]">
        ...
        <form method="post" class="w-full">
          <div class="mb-8">
            <h3 class="text-2xl font-extrabold text-indigo-500">Register</h3>
          </div>
          <div class="space-y-6">
            <div>
          ...
          <div class="!mt-10">
            <button type="submit" name="btnregister" class="w-full py-3 px-4 text-sm font-semibold rounded bg-blue-600 hover:bg-blue-700 text-white focus:outline-none">
              Create Account
            </button>
          </div>
          <p class="text-sm mt-6 text-center text-neutral-400">Already have an account? <a href="index.php" class="text-blue-600 font-semibold hover:underline ml-1">Login here</a></p>
        </form>
      </div>
    </div>
  </div>
